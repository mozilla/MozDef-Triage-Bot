# MozDef Alert Triage Bot 0.3 Specification

**This specification is a living document until the release of v0.3.**
...
Version 0.3 must satisfy the following user stories.
...
![Components Diagram](../diagrams/bot_architecture_v0_3.png)
...
the [API documentation](../api/v0_3.md).
...
Version 0.3 of the Triage Bot will support alerting for only one user at a
time.
