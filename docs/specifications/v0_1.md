...
from API Gateway indicating that the Alert Action component has sent a new
...
to the relevant user.  This component has three core responsibilities:
...
3. Set the alert's status to `inProgress`.
